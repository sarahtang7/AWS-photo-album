...
apigClientFactory.newClient = function (config) {
    ...
    if(config.apiKey === undefined) {
        config.apiKey = 'UanQ3MzpFp7t4ZNfy5pHu5gERtcGo0cw2fRpnPfK';
    }
    ...
    var invokeUrl = 'https://s03esw73ke.execute-api.us-east-1.amazonaws.com/cf-photosalbum-stage';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-api-key', 'body', 'q'], ['body']);
